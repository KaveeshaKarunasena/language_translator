...
exports.accountRoute.post('/createAccount', (0, validator_1.default)([
    (0, express_validator_1.body)('email').isEmail().normalizeEmail().withMessage("Enter an Valid Email "),
    (0, express_validator_1.body)('password').isString().isLength({ min: 8 }).withMessage("Password needs have atleast 8 characters "),
